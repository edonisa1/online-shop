...
<!-- Pre Header -->
    <div id="pre-header">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <span>Pixie-Faqja më e njohur për blerje online!</span>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
              <a class="nav-link" href="index.php">Kryefaqja
            ...
            <li class="nav-item">
              <a class="nav-link" href="contact.php">Na kontaktoni</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="login.php">Kyqu</a>
            </li>
